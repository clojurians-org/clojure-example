...
(ns hadoop.bolome.model.d_bolome_inventory
...
(defn -main []
  ...
  (as-> (<- [?dw-dt ?dw-ts ?dw-src-id
            ...
            ((hfs-delimited "hdfs://192.168.1.3:9000/user/hive/warehouse/ods.db/d_bolome_inventory" :skip-header? false :delimiter "\001")
             :> ?dw-dt ?dw-ts ?dw-src-id
                ?snapshot-dt ?warehouse-id ?barcode ?stock))
      $
      (?- (hfs-delimited "hdfs://192.168.1.3:9000/user/hive/warehouse/model.db/d_bolome_inventory"
